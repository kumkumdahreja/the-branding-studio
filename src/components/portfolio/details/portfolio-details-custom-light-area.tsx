            ...
            <div className="col-xl-8 col-lg-8">
              <div className="project-details-1-title-box">
                ...
                <p className="mb-35 tp_title_anim">
                  Designing a portfolio for a wonderful Photographer The site
                  promotes the stunning work of Russian photographer Elena
                  Iv-Skaya. Elena has a passion for highly aesthetic, strong and
                  elegant imagery with saturated colors, and I built a
                  minimalist layout that let her work stand out on its own.
                </p>
                <Link
            ...
            <div className="col-xl-6">
              <div className="pd-visual-left-text">
                <span className="tp-char-animation">
                  Visually match Elena personal style
                </span>
              </div>
            </div>
            <div className="col-xl-6">
              <div className="pd-visual-right-content">
                <p className="tp_title_anim">
                  The design needed to be as elegant and clean as possible. I
                  chose a serif font that felt like one you’d see in a fashion
                  newspaper, and plenty of negative space ensures that the
                  pictures do not fight with each other for attention. I also
                  used very muted colors to keep the focus on the saturated ones
                  in Elena’s photos.
                </p>
