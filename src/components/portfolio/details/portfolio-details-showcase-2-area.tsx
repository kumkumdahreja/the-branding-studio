  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(/assets/img/inner-project/showcase/showcase-details-2-1.jpg)",
        }}
      >
        ...
        <div
          className="showcase-details-2-wrapper"
          data-lag="0.2"
          data-stagger="0.08"
        >
            ...
            <div className="row">
              <div className="col-xl-8">
                <div className="showcase-details-2-title-box">
                  <h5 className="showcase-details-2-title mb-20 tp-char-animation">
                    World Fashion
                  </h5>
                  <span className="showcase-details-2-subtitle tp_title_anim">
              ...
              <div className="col-xxl-7 col-xl-10">
                <div className="showcase-details-2-content tp_title_anim">
                  <p>
                    ...
                    sed volutpat elit cum. Viverra dolor maecenas amet dui Netus
                    aliquet.!
                  </p>
                </div>
          ...
          <div className="row">
            ...
            <div className="col-xl-9">
              <div className="showcase-details-2-section-right tp_title_anim">
                <p>
                  Liko website was using a generic template, felt quite outdated
                  and not in-line with the quality of his work. The main goal
                  was to translate his high-end photography into a digital
                  experience that would honor and present his work in a
                  memorable and contemporary way.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="col-xl-9">
              <div className="showcase-details-2-content-right tp_title_anim">
                ...
                <p>
                  ...
                  options in the custom content management system. The styling
        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-xl-9">
              <div className="showcase-details-2-content-right tp_title_anim">
                <p>
                  The journey of visiting Khajuraho and mapping out all temples
                  for the Khajuraho Digital Expo by HASPR was a truly immersive
                  experience. Our team was tasked with capturing the essence of
                  the UNESCO World Heritage Site and bringing it to life through
                  digital technology.
                </p>
              </div>
            </div>
            ...
            <div className="col-xl-9">
              <div className="showcase-details-2-content-right tp_title_anim">
                <p>
                  Each case study gets its own identity through the styling
                  options in the custom content management system. The styling
                  options are pre-defined by our design team to makes sure the
                  website looks amazing in every composition.
                </p>
              </div>
            </div>
          </div>
